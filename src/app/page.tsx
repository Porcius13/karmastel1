...
export default function LandingPage() {
    return (
        <div className="min-h-screen bg-background text-foreground font-[family-name:var(--font-inter)] selection:bg-primary selection:text-primary-foreground overflow-x-hidden transition-colors duration-300">
            ...
            <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-6">
                ...
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-full pointer-events-none">
                    <div className="absolute top-20 left-20 w-[500px] h-[500px] bg-primary/20 rounded-full blur-[120px] opacity-40 mix-blend-screen animate-pulse"></div>
                    <div className="absolute top-40 right-20 w-[400px] h-[400px] bg-purple-500/10 rounded-full blur-[100px] opacity-30 mix-blend-screen"></div>
                </div>
                ...
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
                    ...
                    <div className="space-y-8 text-center lg:text-left">
                        ...
                        <h1 className="text-5xl md:text-7xl font-black tracking-tighter leading-[1.1] font-[family-name:Space_Grotesk] text-foreground">
                            Stop losing <br />
                            your <span className="text-primary decoration-wavy underline decoration-primary/50 underline-offset-8">tabs</span>.
                        </h1>
                    ...
                    <div className="relative group perspective-1000">
                        <div className="relative z-10 transform transition-transform duration-700 hover:rotate-y-6 hover:rotate-x-6">
                            <div className="rounded-3xl border border-white/10 dark:border-white/5 overflow-hidden shadow-2xl bg-surface/50 backdrop-blur-xl p-2">
                                <Image
                            ...
                            <div className="absolute -left-12 bottom-12 p-4 bg-surface border border-border rounded-2xl shadow-xl flex items-center gap-4 animate-bounce duration-[3000ms]">
                                ...
                                <div>
                                    <p className="font-bold text-foreground">Item Added</p>
                                    <p className="text-xs text-muted-foreground">Just now via Extension</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="group bg-surface border border-border rounded-3xl p-8 hover:border-primary/50 transition-all duration-300 hover:shadow-glow hover:-translate-y-2">
                            <div className="w-14 h-14 bg-background border border-border rounded-2xl flex items-center justify-center text-primary mb-6 group-hover:scale-110 transition-transform">
                                <Puzzle size={28} />
                            </div>
                            <h3 className="text-2xl font-bold text-foreground mb-3 font-[family-name:Space_Grotesk]">1. Save Items</h3>
                        ...
                        {/* Step 2 */}
                        <div className="group bg-surface border border-border rounded-3xl p-8 hover:border-primary/50 transition-all duration-300 hover:shadow-glow hover:-translate-y-2">
                            <div className="w-14 h-14 bg-background border border-border rounded-2xl flex items-center justify-center text-blue-400 mb-6 group-hover:scale-110 transition-transform">
                                <FolderOpen size={28} />
                            </div>
                            <h3 className="text-2xl font-bold text-foreground mb-3 font-[family-name:Space_Grotesk]">2. Organize</h3>
                            <p className="text-muted-foreground leading-relaxed">
                        ...
                        {/* Step 3 */}
                        <div className="group bg-surface border border-border rounded-3xl p-8 hover:border-primary/50 transition-all duration-300 hover:shadow-glow hover:-translate-y-2">
                            <div className="w-14 h-14 bg-background border border-border rounded-2xl flex items-center justify-center text-green-400 mb-6 group-hover:scale-110 transition-transform">
                                <Activity size={28} />
                            </div>
                            <h3 className="text-2xl font-bold text-foreground mb-3 font-[family-name:Space_Grotesk]">3. Track & Buy</h3>
                            <p className="text-muted-foreground leading-relaxed">
            ...
            <section className="py-32 px-6 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto text-center relative z-10 space-y-8">
                    <h2 className="text-4xl md:text-6xl font-black tracking-tighter font-[family-name:Space_Grotesk] text-foreground">
